      ...
      <div className="news-layout">
        ...
        <article className="news-article">
          ...
          <section className="news-content">
            {news.contentBlocks?.map((b, i) => {
              if (b.type === "text") return <p key={i}>{b.value}</p>;
              if (b.type === "image") return <img key={i} src={b.value} className="content-img" alt={`img-${i}`} />;
              if (b.type === "link") return <a key={i} href={b.value} target="_blank">{b.value}</a>;
              if (b.type === "affiliate" && news.affiliateLinks?.length > 0) {
                const aff = news.affiliateLinks.find(a => a.link === b.value);
                return aff ? (
                  <a key={i} href={aff.link} target="_blank" className="affiliate-inline">
            ...
            {news.externalLink && (
              <p className="external-link">
                Read more: <a href={news.externalLink} target="_blank">{news.externalLink}</a>
              </p>
            )}
            ...
            {news.adsLink && (
              <div className="ads-banner">
                <a href={news.adsLink} target="_blank">
