...
const AddEditNews = () => {
  ...
  const loadNews = async () => {
    try {
      ...
      setForm({
        ...
        imageRedirectUrl: n.imageRedirectUrl || n.imageRedirectLink || n.image_redirect_url || "",
        ...
        contentBlocks: n.contentBlocks?.length
          ? n.contentBlocks.map(b => ({ ...b, heading: b.heading || "" }))
          : [createEmptyBlock()],
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      imageRedirectUrl: form.imageRedirectUrl || ""
    };
  ...
  return (
    <div className="admin-page">
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <input name="imageRedirectUrl" value={form.imageRedirectUrl} onChange={handleChange} placeholder="Image Redirect Link" />
        ...
        {form.contentBlocks.map((b, i) => (
          <div key={i} className="block-row">
            ...
            {b.type === "image" && (
              <input
                value={b.redirectUrl || ""}
                onChange={e => updateBlock(i, "redirectUrl", e.target.value)}
