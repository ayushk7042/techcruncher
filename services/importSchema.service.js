...
const COLUMNS = [
  ...
  { key: "authorRedirectUrl", header: "Author Redirect URL", type: "url", help: "Where clicking the author name goes.", example: "https://driftdine.com/authors/meera" },
  ...
  { key: "videoRedirect", header: "Video Redirect", type: "url", help: "Where clicking the video card goes.", example: "https://driftdine.com/watch/yakushima" },
  ...
  /* ---------------- SEO ---------------- */
  { key: "metaTitle", header: "Meta Title", type: "text", help: "SEO title. Falls back to the article title.", example: "Yakushima Trail Reopens After 40 Years | Driftdine" },
